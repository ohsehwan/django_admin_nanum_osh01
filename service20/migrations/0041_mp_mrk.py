    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_cd', models.CharField(blank=True, max_length=10, null=True, verbose_name='채점항목코드-SEQ별')),
                ('item_nm', models.CharField(blank=True, max_length=60, null=True, verbose_name='채점항목명')),
