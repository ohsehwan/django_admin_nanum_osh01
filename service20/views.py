...
def MS0101M_save(request):
    ...
    cursor.execute("insert into service20_msch (ms_id, status, ms_name,tot_apl,cnt_apl,cnt_doc_suc,cnt_doc_res,cnt_intv_pl,cnt_intv_ac,cnt_intv_suc,cnt_iintv_res,cnt_trn,cnt_mtr) values ('ms1','80','aa','20','20','20','10','10','10','10','10','10','10')")    
